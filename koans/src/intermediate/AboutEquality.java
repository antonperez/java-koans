...
public class AboutEquality {
	...
	static class Car {
		...
		public boolean equals(Object other) {
            ...
            Car car = (Car) other;
			if (this.name == car.name && this.horsepower == car.horsepower)
				result = true;
	...
	public void ownHashCodeImplementationPartTwo() {
		...
		// Does this still fit the hashCode contract? Why?	-- No, as hashcode is always 4000
		// If it's valid why is this still not a good idea? -- Means everything will be in the same bucket in hash-based ds
	}
