...
public class AboutCasting {
	...
	public void downCastWithInheritance() {
		...
		Parent parentReference = child; // Why isn't there an explicit cast?  - Because child is a Parent
	...
	public void upCastWithInheritance() {
		...
		Child childReference = (Child) parentReference; // Or here? - Because we are downcasting
	...
	public void classCasting() {
		try {
			...
			((Sleepable) grandparent).sleep(); // would this even compile without the cast?
